const en = {
    ...
    twoFactorSetupTip: 'Scan the QR code below and add this key to your authenticator app',
    twoFactorDisableTip: 'Enter the verification code from your authenticator app to disable two-factor authentication',
    ...
    queueEnabledDesc: 'When enabled, emails will be queued for async sending for faster response. Requires Local Docker API to be configured.',
    oss: 'Object Storage',
    osDomain: 'Domain',
    ...
    tempFileCleanDaysDesc: 'Clean temp files and deleted email attachments older than this many days',
    tempFileStats: 'Temp Files Status',
    tempFiles: 'files',
    noTempFiles: 'No temp files',
    tempFileCleanupConfirm: 'Confirm cleaning all expired temp files and deleted email attachments?',
